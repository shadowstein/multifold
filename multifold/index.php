  ...
  if (!file_exists($path)) { ?>
    <div id="banner">
      <div id='pictures' class = 'pics'>
        ...
        <img class="jpg" id='jpg3' src="images/netcrunch_main.png" width=720px height=300px />
        <img class="jpg" id='jpg4' src="images/hourglass_main.png" width=720px height=300px />
      </div>
    </div>
<?php } else { ?> 
